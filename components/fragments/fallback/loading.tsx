...
export const Loading: FC<FallbackProps> = ({ width = '100%', height = '100%', className = '', style }) => {
  ...
  return (
    <div className={cn('flex items-center my-8 justify-center bg-background', className)} style={containerStyle}>
